...
session_start();
    if(isset($_SESSION['username']) && isset($_SESSION['role']) && !empty($_SESSION['username']) && !empty($_SESSION['role'])){
        if($_SESSION['role']=='chef'){
			...
			<head>
			    <meta charset="UTF-8">
			    <title>Chef Dashboard | Fuu</title>
			    <link href="../logo.jpg" rel="icon"/>
			</head>
			<body>
				<h2>Welcome <?php echo $var1; ?></h2>
				<br>
				<h3>Fuu Chef Dashboard</h3>
				<br>
				<a href="pending.php">Pending Orders</a> | <a href="editprofile.php">Edit Profile</a> | <a href="../logout.php">Log Out</a><br>
